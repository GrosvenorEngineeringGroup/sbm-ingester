"""Unit tests for nem12_exporter/downloader.py module.
...
class TestFormatDateForUrl:
    ...
    def test_formats_date_correctly(self) -> None:
        ...
        from nem12_exporter.downloader import format_date_for_url
...
class TestPrefixNmiInNem12:
    ...
    def test_prefixes_single_200_record(self) -> None:
        from nem12_exporter.downloader import _prefix_nmi_in_nem12
